...
export default function AddMealModal({showModal,setShowModal,mealDatabase}:AddMealModalProps){
    ...
    const submitMeal = async (typedValue) => {
        await db.meals.add({
            ...
            date: newMealState.date,
            type: newMealState.type
        });
        setShowModal(false);
    };
                        ...
                        <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="w-full mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <h3 className="text-base font-semibold leading-6 text-gray-900" id="modal-title">Add Meal for {getWeekdayString(newMealState.date)} {newMealState.type}</h3>
                                    <div className="mt-2">
                                        <MealCombobox
